...
- (id)initWithDataCursor:(CDMachOFileDataCursor *)cursor;
{
    if ((self = [super initWithDataCursor:cursor])) {
...
#if 0
        NSLog(@"ilocalsym:      0x%08x  %d", _dysymtab.ilocalsym, _dysymtab.ilocalsym);
        NSLog(@"nlocalsym:      0x%08x  %d", _dysymtab.nlocalsym, _dysymtab.nlocalsym);
        NSLog(@"iextdefsym:     0x%08x  %d", _dysymtab.iextdefsym, _dysymtab.iextdefsym);
        NSLog(@"nextdefsym:     0x%08x  %d", _dysymtab.nextdefsym, _dysymtab.nextdefsym);
        NSLog(@"iundefsym:      0x%08x  %d", _dysymtab.iundefsym, _dysymtab.iundefsym);
        NSLog(@"nundefsym:      0x%08x  %d", _dysymtab.nundefsym, _dysymtab.nundefsym);
        
        NSLog(@"tocoff:         0x%08x  %d", _dysymtab.tocoff, _dysymtab.tocoff);
        NSLog(@"ntoc:           0x%08x  %d", _dysymtab.ntoc, _dysymtab.ntoc);
        NSLog(@"modtaboff:      0x%08x  %d", _dysymtab.modtaboff, _dysymtab.modtaboff);
        NSLog(@"nmodtab:        0x%08x  %d", _dysymtab.nmodtab, _dysymtab.nmodtab);
        
        NSLog(@"extrefsymoff:   0x%08x  %d", _dysymtab.extrefsymoff, _dysymtab.extrefsymoff);
        NSLog(@"nextrefsyms:    0x%08x  %d", _dysymtab.nextrefsyms, _dysymtab.nextrefsyms);
        NSLog(@"indirectsymoff: 0x%08x  %d", _dysymtab.indirectsymoff, _dysymtab.indirectsymoff);
        NSLog(@"nindirectsyms:  0x%08x  %d", _dysymtab.nindirectsyms, _dysymtab.nindirectsyms);
        
        NSLog(@"extreloff:      0x%08x  %d", _dysymtab.extreloff, _dysymtab.extreloff);
        NSLog(@"nextrel:        0x%08x  %d", _dysymtab.nextrel, _dysymtab.nextrel);
        NSLog(@"locreloff:      0x%08x  %d", _dysymtab.locreloff, _dysymtab.locreloff);
        NSLog(@"nlocrel:        0x%08x  %d", _dysymtab.nlocrel, _dysymtab.nlocrel);
#endif
        ...
        if (_dysymtab.indirectsymoff<[[[self machOFile] data] length])
        {
            int i;
            //unsigned long* indSymTab = (unsigned long*)[[self machOFile] bytesAtOffset:_dysymtab.indirectsymoff]; //TODO: This is the original line and should probably put back
            uint8_t* indSymTab = (uint8_t*)[[self machOFile] bytesAtOffset:_dysymtab.indirectsymoff];
            
            for (i=0;i<_dysymtab.nindirectsyms;i++)
                [temp addObject:[[NSNumber alloc] initWithLong:indSymTab[i]]];
        }
        _dSymbols = [[NSArray alloc] initWithArray:temp];
    }
...
- (int)nextrel
{
    return _dysymtab.nextrel;
}

- (long)extreloff
{
    return _dysymtab.extreloff;
}
