...
@end
	...
	for (disEnum=0;disEnum<[disArray count];disEnum++)
	{
		...
		NSLog(@"%@\n",dis);
#endif
		// do ppc simulation using fancy new simulator class
		[ppcSimulator simulateLine:thisLine withOffset:offset];
		...
		else if ([[thisLine op] isEqualToString:@"b"])
		{
			 ...
			 * as opposed to short branches.  Presumably, this would be the same in any gcc compiled PPC binary
			 *//*
